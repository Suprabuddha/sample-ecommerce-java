 ...
 * Updated to use SecurityFilterChain pattern for Spring Boot 3 compatibility
 */
@Configuration
@EnableWebSecurity
public class SecurityConfig {
     ...
     * Updated from deprecated WebSecurityConfigurerAdapter to SecurityFilterChain bean
     */
    @Bean
